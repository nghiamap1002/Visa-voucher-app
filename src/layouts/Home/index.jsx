...
import natureImage from '../../assets/images/meow.webp'
        ...
        <>
            <header className="bg-black text-white border-b border-gray-700">
                <nav className="flex justify-around items-center h-16">
                    <svg width="120" height="44" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 118 30" alt="Tiktok">
            ...
            <main className="flex w-screen bg-black text-white">
                        ...
                        <div>
                            <div className="flex gap-3 p-2 cursor-pointer font-semibold rounded ">
                                <div className="md:w-16 md:h-16 w-10 h-10">
                                    <img className=" rounded-full w-14" src={avatarImage} alt="user-profile" />
                                </div>
                                <div className="w-full max-w-[600px]">
                                    <div className="flex items-center justify-between gap-2">
                                        <div className="flex flex-row items-center gap-2">
                                            <p className="flex gap-2 items-center md:text-md font-bold text-primary">
                                                deehcan <svg viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"><g clipPath="url(#Icon_Color-Verified_Badge_svg__a)"><path d="M0 24a24 24 0 1 1 48 0 24 24 0 0 1-48 0Z" fill="#20D5EC"></path><path fillRule="evenodd" clipRule="evenodd" d="M37.12 15.88a3 3 0 0 1 0 4.24l-13.5 13.5a3 3 0 0 1-4.24 0l-8.5-8.5a3 3 0 1 1 4.24-4.24l6.38 6.38 11.38-11.38a3 3 0 0 1 4.24 0Z" fill="#fff"></path></g><defs><clipPath id="Icon_Color-Verified_Badge_svg__a"><path fill="#fff" d="M0 0h48v48H0z"></path></clipPath></defs></svg>
                                            </p>
                ...
                >
                    <div className="bg-gradient-to-b from-pink-500 to-red-500 mx-auto rounded-lg shadow-lg px-6 py-10 text-center text-white">
